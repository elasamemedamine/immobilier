...
<div class="row">
    ...
    <div class="mb-3">
        ...
        <button class="btn btn-primary" type="submit"><a class="text-decoration-none text-white" href="{{ route('dashboard.index') }}">Back</a></button>

    </form>
</div>
</div>
<div class="col-lg-4 my-4">
<img src="{{ asset('images/Day-and-Night-unscreen.gif') }}" alt="Day and Night" width="350px" class="img-fluid">
</div>
</div>
@endsection
