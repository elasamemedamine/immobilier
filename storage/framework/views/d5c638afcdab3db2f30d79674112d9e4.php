...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <img src="\images\immobilier.png" class="img-fluid" width="200px" alt="Imobilier.shop">
        <h1 class="h2 my-4">Welcome to immobilier.shop</h1>
        <div class="text-center">
  <a href="<?php echo e(route('properties.index')); ?> " class="btn btn-primary mb-3 fw-bold text-decoration-none text-white"><i class="fa-solid fa-arrow-up-right-from-square fa-sm"></i> Immobilier Explorer</a>
        </div>
...
<?php echo $__env->make('properties.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Desktop\project\immobilier\resources\views/ourservice.blade.php ENDPATH**/ ?>